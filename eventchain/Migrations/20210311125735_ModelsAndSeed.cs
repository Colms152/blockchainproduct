        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    walletPk = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    walletAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Organiser = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    eventGenre = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ticketNotAvailable = table.Column<bool>(type: "bit", nullable: false),
                    ticketRedeemed = table.Column<bool>(type: "bit", nullable: false),
                    eventId = table.Column<int>(type: "int", nullable: false),
                    userId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
