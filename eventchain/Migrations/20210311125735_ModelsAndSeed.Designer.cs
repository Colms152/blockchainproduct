...
namespace eventchain.Migrations
{
    ...
    [Migration("20210311125735_ModelsAndSeed")]
    partial class ModelsAndSeed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eventchain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eventchain.Models.Ticket", b =>
                {
                    ...
                    b.Property<bool>("ticketNotAvailable")
                        .HasColumnType("bit");

                    b.Property<bool>("ticketRedeemed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eventchain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eventchain.Models.Ticket", b =>
                {
                    b.HasOne("eventchain.Models.Event", "eventID")
                        .WithMany("Tickets")
